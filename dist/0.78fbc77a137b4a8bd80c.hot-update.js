	  ...
	  */
	  ...
	  websocket.on('connection', socket => {
	    ...
	    socket.on('dmx-go', buffer => {
	      ...
	      db.collection('last_known_universe').save({ _id: "last_known_universe", dmx_data: dmx_usb_pro.universe }, { w: 1 }, callback);
	    });
...
//# sourceMappingURL=0.78fbc77a137b4a8bd80c.hot-update.js.map