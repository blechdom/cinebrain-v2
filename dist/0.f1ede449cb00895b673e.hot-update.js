	  ...
	  */
	  ...
	  websocket.on('connection', socket => {
	    ...
	    socket.on('dmx-go', buffer => {
	      ...
	      db.collection('last_known_universe').save({ _id: "last_known_universe", dmx_data: dmx_usb_pro.universe }, { w: 1 }, function (err, records) {
...
//# sourceMappingURL=0.f1ede449cb00895b673e.hot-update.js.map