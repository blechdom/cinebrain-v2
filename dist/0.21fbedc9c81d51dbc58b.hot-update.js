	  ...
	  */
	  ...
	  websocket.on('connection', socket => {
	    ...
	    socket.on('dmx-save-preset', data => {
	      db.collection('dmx_presets').update({ instrument: data.instrument_id, preset_num: data.preset_num, dmx_offset: data.dmx_offset }, newDMXPreset, { upsert: true });
	    });
...
//# sourceMappingURL=0.21fbedc9c81d51dbc58b.hot-update.js.map