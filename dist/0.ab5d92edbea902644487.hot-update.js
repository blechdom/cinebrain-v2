...
/***/ (function(module, exports, __webpack_require__) {
	...
	_mongodb.MongoClient.connect('mongodb://localhost/cinebrain').then(connection => {
	  ...
	  //db.collection("last_known_universe").find( { _id: "last_known_universe" }, function(err, result) {
	  //if (err) throw err;
	  ...
	  */
	  ...
	  websocket.on('connection', socket => {
	    ...
	    socket.on('dmx-go', buffer => {
	      ...
	      let dmx_data = JSON.parse(JSON.stringify(dmx_usb_pro.universe));
	      console.log("dmx translate: " + dmx_data + " or further " + dmx_data.data);
...
//# sourceMappingURL=0.ab5d92edbea902644487.hot-update.js.map