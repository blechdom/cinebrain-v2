...
/***/ (function(module, exports, __webpack_require__) {
	...
	DMX.prototype.update = function (u, offset) {
		...
		for (var c in u) {
			...
			console.log("c+offset-1 " + (parseFloat(c) + parseFloat(offset) - 1));
			this.universe[parseFloat(c) + parseFloat(offset) - 1] = u[c];
		}
		this.send_universe();
	};
...
//# sourceMappingURL=0.00fd588de00eb57dabfa.hot-update.js.map