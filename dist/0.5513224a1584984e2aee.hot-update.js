	...
	class DMXWashGroup1 extends _react2.default.Component {
	  ...
	  handleSliders(event) {
	    ...
	    switch (event.target.id) {
	      ...
	      case 'wash_intensity':
	        //this.setState({dmx_data[0]:slider_value});
	        socket.emit('dmx-go', { dmx: { 1: slider_value }, offset: this.state.dmx_offset });
	        break;
	      case 'wash_pan':
	        slider_value = slider_value / 255 * 86 + 42;
	        //this.setState({dmx_data[6]:slider_value});
	        socket.emit('dmx-go', { dmx: { 7: slider_value }, offset: this.state.dmx_offset });
	        break;
	      case 'wash_tilt':
	        slider_value = 210 - slider_value / 255 * 86;
	  ...
	  savePreset(preset) {
	    const newDMXPreset = {
	      ...
	      dmx_data: this.state.dmx_data, created: new Date()
	    };
...
//# sourceMappingURL=0.5513224a1584984e2aee.hot-update.js.map