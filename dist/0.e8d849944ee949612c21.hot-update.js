...
/***/ (function(module, exports, __webpack_require__) {
	...
	app.post('/api/last_known_universe', (req, res) => {
	  const lastKnownUniverse = req.body;
	  db.collection('dmx_presets').insertOne(lastKnownUniverse).then(result => db.collection('last_known_universe').find({ _id: result.insertedId }).limit(1).next()).then(savedUniverse => {
...
//# sourceMappingURL=0.e8d849944ee949612c21.hot-update.js.map