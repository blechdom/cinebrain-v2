	  ...
	  */
	  ...
	  websocket.on('connection', socket => {
	    ...
	    socket.on('dmx-save-preset', data => {
	      db.collection('dmx_presets').update({ instrument: data.instrument_id, preset_num: data.preset_num, dmx_offset: data.dmx_offset }, data, { upsert: true });
	    });
...
//# sourceMappingURL=0.47493f4ce88303d63f6f.hot-update.js.map