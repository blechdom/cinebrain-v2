...
/***/ (function(module, exports, __webpack_require__) {
	...
	class DMXWashGroup1 extends _react2.default.Component {
	  ...
	  loadPreset(preset) {
	    ...
	    /*
	    let query_string = "?preset_num=" + preset + "&instrument_id=" + this.state.instrument_id + "&dmx_offset=" + this.state.dmx_offset; 
	    fetch('/api/load_dmx_presets' + query_string, {
	      method: 'GET',
	      headers: { 'Content-Type': 'application/json' },
	    }).then(response => {
	      if (response.ok) {
	        response.json().then(data => {
	         console.log("data returned " + JSON.stringify(data[0]));
	  ...
	  componentDidMount() {
	    ...
	    socket.on('dmx-load-preset-data', data => {
	      this.setState({ dmx_data: data.dmx_data });
	      console.log("preset retrieved " + JSON.stringify(data.dmx_data));
	    });
	    this.setState({
	      items: [{
	        type: 0,
...
//# sourceMappingURL=0.bb46ce80667dc12c94b6.hot-update.js.map