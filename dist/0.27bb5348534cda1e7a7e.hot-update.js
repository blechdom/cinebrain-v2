...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	app.get('/api/load_dmx_presets', (req, res) => {
	  ...
	  db.collection('dmx_presets').find({ instrument: req.query.instrument_id, preset_num: req.query.preset_num, dmx_offset: req.query.dmx_offset }).toArray().then(dmx_presets => {
	    console.log("res " + JSON.stringify(dmx_presets));
	    res.json({ dmx_data: dmx_presets.dmx_data });
	  }).catch(error => {
	    console.log(error);
...
//# sourceMappingURL=0.27bb5348534cda1e7a7e.hot-update.js.map