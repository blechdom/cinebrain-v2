...
/***/ (function(module, exports, __webpack_require__) {
	...
	class DMXWashGroup1 extends _react2.default.Component {
	  ...
	  loadPreset(preset) {
	    socket.emit('load-dmx-preset', { preset_num: preset, instrument_id: this.state.instrument_id, dmx_offset: this.state.dmx_offset });
	  }
	  ...
	  componentDidMount() {
	    ...
	    socket.on('dmx-preset-load', dmx_data => {
	      console.log("got a preset back from the server/database " + dmx_data);
	    });
	    this.setState({
	      items: [{
	        type: 0,
...
//# sourceMappingURL=0.0d309e07215c4840941a.hot-update.js.map