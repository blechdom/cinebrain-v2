...
/***/ (function(module, exports, __webpack_require__) {
	...
	class DMXWashGroup1 extends _react2.default.Component {
	  ...
	  static dataFetcher(_ref) {
	    ...
	    return fetch(`${urlBase || ''}/api/dmx_presets${parameters.search}`).then(response => {
	      if (!response.ok) return response.json().then(error => Promise.reject(error));
	      return response.json().then(this.state.dmx_data = data.dmx_data);
	    });
	  }
...
//# sourceMappingURL=0.9c9aa72df938a5ad17f8.hot-update.js.map