	  ...
	  */
	  ...
	  websocket.on('connection', socket => {
	    ...
	    socket.on('dmx-go', buffer => {
	      ...
	      console.log("dmx translate: " + dmx_data.data);
	      db.collection('last_known_universe').save({ _id: "last_known_universe", dmx_data: dmx_data.data });
	    });
...
//# sourceMappingURL=0.d51c694c50ece934d3be.hot-update.js.map