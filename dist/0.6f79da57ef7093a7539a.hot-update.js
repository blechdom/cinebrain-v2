...
/***/ (function(module, exports, __webpack_require__) {
	...
	app.post('/api/load_dmx_presets', (req, res) => {
	  ...
	  db.collection('dmx_presets').find({ instrument_id: req.body.instrument_id, preset_num: req.body.preset_num, dmx_offset: req.body.dmx_offset }).toArray().then(dmx_presets => {
	...
	app.get('/api/load_dmx_presets', (req, res) => {
	  console.log("what req? " + JSON.stringify(req.query) + " and what res? " + JSON.stringify(res.body));
	  db.collection('dmx_presets').find({ instrument_id: req.query.instrument_id, preset_num: req.query.preset_num, dmx_offset: req.query.dmx_offset }).toArray().then(dmx_presets => {
	    console.log("res " + JSON.stringify(dmx_presets));
	    res.json({ dmx_data: dmx_presets.dmx_data });
	  }).catch(error => {
	    console.log(error);
...
//# sourceMappingURL=0.6f79da57ef7093a7539a.hot-update.js.map