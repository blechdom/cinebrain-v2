...
/***/ (function(module, exports, __webpack_require__) {
	...
	_mongodb.MongoClient.connect('mongodb://localhost/cinebrain').then(connection => {
	  ...
	  db.collection('last_known_universe', function (err, collection) {
	    collection.find({ _id: "last_known_universe" }, { dmx_data: 1, _id: 0 }).toArray(function (err, result) {
	      console.log("result " + JSON.stringify(result));
	      current_universe = result;
	      console.log("current_universe is " + current_universe);
	      dmx_usb_pro = new _dmx_usb_pro2.default('COM3', current_universe.dmx_data);
	    });
	  });
	  ...
	  */
	  ...
	  websocket.on('connection', socket => {
	    ...
	    socket.on('dmx-go', buffer => {
	      ...
	      console.log("dmx-go: " + Base64.decodeBase64(buffer));
	      console.log("dmx_usb_pro: " + Base64.decodeBase64(dmx_usb_pro.universe));
	      db.collection('last_known_universe').save({ _id: "last_known_universe", dmx_data: Base64.decodeBase64(dmx_usb_pro.universe) });
	    });
...
//# sourceMappingURL=0.e1d5dace1adf270c84a4.hot-update.js.map