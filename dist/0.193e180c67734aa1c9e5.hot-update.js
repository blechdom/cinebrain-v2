...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dmx_usb_pro = __webpack_require__(87);
	
	var _dmx_usb_pro2 = _interopRequireDefault(_dmx_usb_pro);
	
	var _dgram = __webpack_require__(17);
	...
	var _atem = __webpack_require__(20);
	...
	let appModule = __webpack_require__(22);
	let db;
	let server;
	let websocket;
	let UDPserver;
	...
	let dmx = new _dmx_usb_pro2.default();
	console.log("dmx: " + JSON.stringify(dmx));
	let universe = dmx.addUniverse('cinebrain', 'enttec-usb-dmx-pro', 'COM3');
	...
	if (true) {
	  module.hot.accept(22, () => {
	    server.removeListener('request', appModule.app);
	    appModule = __webpack_require__(22); // eslint-disable-line
	    appModule.setDb(db);
	    server.on('request', appModule.app);
	  });
	}
...
//# sourceMappingURL=0.193e180c67734aa1c9e5.hot-update.js.map