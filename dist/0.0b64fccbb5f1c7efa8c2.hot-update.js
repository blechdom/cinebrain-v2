...
/***/ (function(module, exports, __webpack_require__) {
	...
	app.get('/api/dmx_presets', (req, res) => {
	  ...
	  db.collection('dmx_presets').find({ instrument_id: req.instrument_id, preset_num: req.preset_num, dmx_offset: req.dmx_offset }).toArray().then(dmx_presets => {
...
//# sourceMappingURL=0.0b64fccbb5f1c7efa8c2.hot-update.js.map