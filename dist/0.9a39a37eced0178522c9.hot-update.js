...
/***/ (function(module, exports, __webpack_require__) {
	...
	app.get('/api/load_dmx_presets', (req, res) => {
	  ...
	  db.collection('dmx_presets').findOne({ instrument: req.query.instrument_id, preset_num: Number(req.query.preset_num), dmx_offset: Number(req.query.dmx_offset) }).toArray().then(dmx_presets => {
...
//# sourceMappingURL=0.9a39a37eced0178522c9.hot-update.js.map