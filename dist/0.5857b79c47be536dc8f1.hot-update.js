	  ...
	  websocket.on('connection', socket => {
	    ...
	    socket.on('dmx-load-preset', data => {
	      ...
	      db.collection('dmx_presets', function (err, collection) {
	        collection.findOne({ instrument_id: data.instrument_id, preset_num: data.preset_num, dmx_offset: data.dmx_offset }, { dmx_data: 1, _id: 0 }, function (err, result) {
	          console.log("result " + JSON.stringify(result));
...
//# sourceMappingURL=0.5857b79c47be536dc8f1.hot-update.js.map